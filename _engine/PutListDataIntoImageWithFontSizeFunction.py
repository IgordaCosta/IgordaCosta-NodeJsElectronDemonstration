...
# #fix the code below it is deleting data when adding data to the database
    ...
    #this is the only time the image is copied
    #This copies the full data and not only switching the end
    #The output is the location inside the program for image
