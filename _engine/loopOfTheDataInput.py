...
def loopOfTheDataInput(BaseFileLocation2,OutputDictionary, FontName, LocationAsked,FontSize, RealListOfColumnnames, dataframe, dataframe0, rw, OutputTableName3Keys, BaseFileLocation, datafillName, ListToPrint):
    ...
    if noError == False:
        ...
        noError2 = CopyFileToNewLocation.CopyFileToNewLocation(getFileLocation=BaseFileLocation2, CopyToLocaion=BaseFileLocation)
        if noError2 == False:
