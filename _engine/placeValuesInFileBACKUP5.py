        ...
        if noError:
            ...
            # this seems to be the place to start the for loop
                ...
                if rw<numberOfRows:
                    ...
                    loopOfTheDataInput.loopOfTheDataInput(RealListOfColumnnames, dataframe, rw, font, OutputTableName3Keys, FinalSaveLocation, BaseFileLocation, datafillName, filePath)
