...
def placeValuesInFile():
    ...
    # BaseFileLocation0 =  '/'.join(BaseFileLocation00.split('\\'))
    ...
    # BaseFileLocation0 = BaseFileLocation01
    ...
    #     loopOfTheDataInput.loopOfTheDataInput(BaseFileLocation2,OutputDictionary, FontName, LocationAsked,FontSize, RealListOfColumnnames, dataframe, dataframe0, rw, OutputTableName3Keys, BaseFileLocation, datafillName, ListToPrint)
        
    #     # noError=False
    #     # returnValue = ''
    #     # try:
    #     #     returnValue = shutil.copy(BaseFileLocation2, BaseFileLocation)
    #     #     noError = True
    #     # except:
    #     #     pass
    #     # noError, RetunValue, TimeNameFull = CopyFileToNewLocation.CopyFileToNewLocation(getFileLocation=BaseFileLocation2, CopyToLocaion=BaseFileLocation, TimeNameFull=TimeNameFull)
    ...
    #                 #     Hash2 = str(getFileHash.getFileHash(filename=BaseFileLocation2))
                        

    #                 #     Hash1 = str(getFileHash.getFileHash(filename=BaseFileLocation))
    ...
    #                 #         print('sleep here')
    #                 #         time.sleep(4)
    #                     # # print(NOTCopiedCompletelly)
    #                     # print('try one')
    #                     # # print('NOTCopiedCompletelly =' + str(NOTCopiedCompletelly))
    #                     # # if NOTCopiedCompletelly == 'True':
    #                     # try:
