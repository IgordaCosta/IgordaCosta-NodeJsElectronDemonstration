...
InputLocation = r'C:\Users\Tigereye\Desktop'+ '\\' + 'TODOAutoformFiller_1.jpg'

SaveLocation = r'C:\Users\Tigereye\Documents\ResizedImagesTest' + '\\' + 'TODOAutoformFiller_1_Larger.jpg'

print(SaveLocation)


resizeImage(InputLocation,SaveLocation,inputImageName = '',outputImageName='',Imageheight=3000)