...
function createTimer(NewEndTimeOfCompletion, AproxTotalTimeComplete, JsInitTimeInMliSeconds, CompareTimeNow){
    ...
    let Topfraction = now - CompareTimeNow1;

    let BottomFraction = countDownDate - CompareTimeNow1 ; 


    // let Topfraction = now - JsInitTimeInMliSeconds1;

    // let BottomFraction = countDownDate - JsInitTimeInMliSeconds1 ; 

    // console.log(Topfraction);

    // console.log('Topfraction');

    // console.log(BottomFraction);

    // console.log('BottomFraction');


    
    let percentage0 = parseInt((Topfraction/BottomFraction)*100);
...
function ProgressBarGotResults(NewEndTimeOfCompletion, AproxTotalTimeComplete, JsInitTimeInMliSeconds, CompareTimeNow) {
    ...
    <div>
        <button type="button" class="btn optionsbtn right btn-secondary" onclick="RunOpenFolderLocation()" >Check Populated Folder</button>
    </div>
