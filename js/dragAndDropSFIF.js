...
function DragnDrop2 () {
    ...
    const { DragnDropMidSFIF } = require(path.join(currentWorkingDirectory, "./js/DragnDropMidSFIF"));
...
function dragAndDropSFIF (){
    location.replace("dragAndDropSFIF.html");
